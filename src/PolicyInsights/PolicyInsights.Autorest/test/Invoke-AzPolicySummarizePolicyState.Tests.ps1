if(($null -eq $TestName) -or ($TestName -contains 'Invoke-AzPolicySummarizePolicyState'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Invoke-AzPolicySummarizePolicyState.Recording.json'
...
Describe 'Invoke-AzPolicySummarizePolicyState' {
    It 'Summarize1' -skip {
